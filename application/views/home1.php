...
<head>
  ...
  <!-- CSS Files -->
  <link href="<?= base_url('assets'); ?>//assets/css/material-kit.css?v=2.0.4" rel="stylesheet" />
...
<body class="index-page sidebar-collapse">
  ...
  <div class="page-header header-filter clear-filter purple-filter" data-parallax="true" style="background-image: url('<?= base_url('assets'); ?>//assets/img/bg2.jpg');">
    <div class="container">
      <div class="row">
  ...
  <!--   Core JS Files   -->
  <script src="<?= base_url('assets'); ?>//assets/js/core/jquery.min.js" type="text/javascript"></script>
  <script src="<?= base_url('assets'); ?>//assets/js/core/popper.min.js" type="text/javascript"></script>
  <script src="<?= base_url('assets'); ?>//assets/js/core/bootstrap-material-design.min.js" type="text/javascript"></script>
  <script src="<?= base_url('assets'); ?>//assets/js/plugins/moment.min.js"></script>
  <!--	Plugin for the Datepicker, full documentation here: https://github.com/Eonasdan/bootstrap-datetimepicker -->
  <script src="<?= base_url('assets'); ?>//assets/js/plugins/bootstrap-datetimepicker.js" type="text/javascript"></script>
  <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
  <script src="<?= base_url('assets'); ?>//assets/js/plugins/nouislider.min.js" type="text/javascript"></script>
  <!--	Plugin for Sharrre btn -->
  <script src="<?= base_url('assets'); ?>//assets/js/plugins/jquery.sharrre.js" type="text/javascript"></script>
  <!-- Control Center for Material Kit: parallax effects, scripts for the example pages etc -->
  <script src="<?= base_url('assets'); ?>//assets/js/material-kit.js?v=2.0.4" type="text/javascript"></script>
  <script>
